...
class BackgroundsService {
  final File _bgsFile = File("slide_backgrounds.ecw.bgs.json");
  ...
  Future<void> loadBackgrounds() async {
    try {
      if (!await _bgsFile.exists()) {
        ...
        final defaultData = {
          "solid": ["Blue", "Red", "Green", "Black", "Purple", "Orange"],
          "image": [
            "C:/Users/kenka/images/image1.jpg",
            "C:/Users/kenka/images/image2.jpg"
          ]
        };
